          ...
          <ul className="space-y-2 font-medium">
            <li>
              <Link to="/DashboardUs" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                ...
                <span className="ms-3">Dashboard User</span>
              </Link>
            </li>
            <li>
              <Link to="/students" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">จัดการนักเรียน</span>
            ...
            <li>
              <Link to="/attendance" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">เช็คชื่อ</span>
