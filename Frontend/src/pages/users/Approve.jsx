...
const RequirementList = () => {
  ...
  const pendingRequests = borrowingRequests.filter(request => request.status === "อนุมัติแล้ว");
                  ...
                  <div className="pt-4 border-t border-gray-200 mt-auto">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                      ...
                      <div className="flex gap-2 w-full md:w-auto">
                        ...
                        <button className={`btn rounded-xl ${request.status === "อนุมัติแล้ว" ? "btn-neutral" : "btn-outline"} btn-sm md:btn-md flex-2 md:flex-none`}>
