                  ...
                  <div className="card-body p-4 md:p-6">
                    ...
                    <div className="pt-4 border-t border-gray-200 mt-auto ">
                      <div className="flex flex-col md:flex-row justify-between items-center gap-4 ">
                        ...
                        <button 
                          className={`btn rounded-xl ${request.status === "อนุมัติ" ? "btn-outline" : "btn-outline"} btn-sm md:btn-md flex-2 md:flex-none hover:bg-blue-600 hover:border-blue-500 border-gray-200 bg-black text-white transition-colors`}
