...
const RequirementList = () => {
  const borrowingRequests = [
    ...
    },
    {
      ...
      cencalReason: "อุปกรณ์ไม่พร้อมใช้งาน",
      items: [
        { 
          name: "ไมโครโฟน", 
          quantity: 2,
  ...
  const pendingRequests = borrowingRequests.filter(request => request.status === "ปฏิเสธ");
                ...
                <div className="md:w-2/3 w-full">
                  <div className="card-body p-4 md:p-6">
                    ...
                    <div className="my-1 bg-red-50 p-3 rounded-lg">
                      ...
                      <p className="text-red-800 text-xl font-bold">{request.cencalReason}</p>
                    </div>
