      ...
      <div className="relative bg-white rounded-2xl shadow-2xl border border-gray-200 max-w-md w-full p-6 z-50">
        ...
        <div className="py-2">
          <div className="text-sm text-gray-600">
            คุณแน่ใจว่าต้องการลบหมวดหมู่
          </div>
          <div className="mt-2 bg-gray-50 p-3 rounded-lg">
            <div className="font-medium text-lg text-gray-900">{selectedCategory?.name}</div>
            <div className="text-sm text-gray-500">รหัส: {selectedCategory?.category_code}</div>
          </div>
