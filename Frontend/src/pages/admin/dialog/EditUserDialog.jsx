    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4 overflow-y-auto">
      <div className="relative w-full max-h-[850px] max-w-6xl mx-auto bg-white rounded-3xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] overflow-hidden animate-fadeIn transition-all duration-300 transform">
        ...
        <div className="flex flex-col md:flex-row h-full">
          {/* Left: Profile Image */}
          <div className="flex flex-col items-center justify-start pt-16 px-10 bg-gradient-to-br from-blue-50 via-indigo-50 to-violet-50 md:min-w-[280px] border-b md:border-r border-gray-100">
            <div className="mb-8">
